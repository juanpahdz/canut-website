...
function register_custom_block_styles() {
  ...
  // 3. Write CSS in _dev/assets/src/sass/block-variations/_media-text.scss targeting that class
  //
  ...
  // ],
  //
  // Then add CSS in _dev/assets/src/sass/block-variations/_media-text.scss:
