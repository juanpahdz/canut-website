...
function get_default_localization_strings( $language = 'en' ) {
  $strings = [
    ...
    'es-CO' => [
      ...
      'Open child menu for'                          => 'Abrir submenú de',
      'Close child menu for'                         => 'Cerrar submenú de',
      'Skip to content'                              => 'Saltar al contenido',
      'Skip over the carousel element'               => 'Saltar el carrusel',
      'External site'                                => 'Sitio externo',
      'opens in a new window'                        => 'se abre en una ventana nueva',
      'Page not found.'                              => 'Página no encontrada.',
      'The reason might be mistyped or expired URL.' => 'La causa puede ser una URL mal escrita o vencida.',
      'Search'                                       => 'Buscar',
      'Block missing required data'                  => 'Al bloque le faltan datos obligatorios',
      'This error is shown only for logged in users' => 'Este error solo se muestra a usuarios con sesión iniciada',
