...
acf_add_local_field_group( [
  ...
  'fields'   => [
    ...
    [
      ...
      'name'         => '',
      'type'         => 'message',
      'message'      => __( 'Meta no tiene un evento estándar para estos 3 pasos del checkout (información de contacto, envío, inicio de pago), así que se envían como eventos personalizados con el nombre configurado abajo. Aparecen en el Administrador de eventos bajo ese nombre - úsalo para crear Conversiones personalizadas si lo necesitas. Vacío = se usa el nombre por defecto.', 'air-light' ),
    ],
    [
