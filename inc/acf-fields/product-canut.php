...
acf_add_local_field_group( [
  ...
  'fields' => [
    ...
    [
      ...
      'name'          => 'reviews_title',
      'type'          => 'text',
      'instructions'  => __( 'Las reseñas de esta sección ya no se editan aquí: son las historias (CPT Historia) vinculadas a este producto por su campo "Producto". Este título es lo único que sigue siendo editable por producto.', 'air-light' ),
